...
import com.uma.umar.exception.UmARRuntimeException;
...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    public static void setNewSalt(String salt) {
        try {
            ...
            throw new UmARRuntimeException(e);
        }
    }
     ...
     * @return
     */
    public static synchronized ObscuredSharedPreferences getPrefs(Context c, String domainName, int contextMode) {
        ...
        return new ObscuredSharedPreferences(c.getApplicationContext(), c.getApplicationContext().getSharedPreferences(domainName, contextMode));
    }
    ...
    public Set<String> getStringSet(String key, Set<String> defValues) {
        throw new UmARRuntimeException("This class does not work with String Sets.");
    }
